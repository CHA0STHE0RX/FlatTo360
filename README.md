...
The idea is :  
1: Extract the original frames with : <br/> `ffmpeg -i input.mp4 -vsync 0 frames\%%06d.png` into 'frames', create a blurred guide and extract keyframes(alternatively use 'select every nth' in the Load Images(Batch) node). (Look:start.bat) 
